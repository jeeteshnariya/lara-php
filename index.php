 ...
 <head>
   ...
   <link rel="preload" as="style" href="https://laravel.com/build/assets/app-a2e3b042.css" />
   <link rel="modulepreload" href="https://laravel.com/build/assets/app-c412b7b5.js" />
   <link rel="stylesheet" href="https://laravel.com/build/assets/app-a2e3b042.css" />
   <script type="module" src="https://laravel.com/build/assets/app-c412b7b5.js"></script>
 ...
 <body x-data="{
   ...
   <div class="absolute top-0 w-full">
     <header x-trap.inert.noscroll="navIsOpen" class="main-header relative z-50 text-gray-700" @keydown.window.escape="navIsOpen = false" @click.away="navIsOpen = false">
       <div class="hidden lg:flex items-center justify-center bg-gradient-to-b from-red-500 to-red-600 p-2 text-center text-white text-sm">
         ...
         <div><svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
         ...
         <div class="max-w-screen-xl mx-auto px-5 flex items-center justify-between">
           ...
           <ul class="relative hidden lg:flex lg:items-center lg:justify-center lg:gap-6 xl:gap-10">
             ...
             <li x-data="{ expanded: false }" class="relative" @keydown.window.escape="expanded = false">
               ...
               <div x-show="expanded" x-cloak class="absolute left-28 z-20 transition transform -translate-x-1/2" x-transition:enter="duration-250 ease-out" x-transition:enter-start="opacity-0 -translate-y-8" x-transition:enter-end="opacity-100" x-transition:leave="duration-250 ease-in" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 -translate-y-8">
                 <div class="mt-4 w-224 p-8 bg-white shadow-lg transform transition-transform origin-top" @click.away="expanded = false">
                   <ul class="grid gap-6 relative sm:grid-cols-2 md:grid-cols-3">
                     <li>
                       <a href="/docs/10.x/starter-kits#laravel-breeze" class="flex">
                     ...
                     <li>
                       <a href="/docs/10.x/billing" class="flex">
                     ...
                     <li>
                       <a href="/docs/10.x/dusk" class="flex">
                     ...
                     <li>
                       <a href="/docs/10.x/broadcasting" class="flex">
                     ...
                     <li>
                       <a href="/docs/10.x/horizon" class="flex">
                     ...
                     <li>
                       <a href="/docs/10.x/octane" class="flex">
                     ...
                     <li>
                       <a href="/docs/10.x/pint" class="flex">
                     ...
                     <li>
                       <a href="/docs/10.x/sail" class="flex">
                     ...
                     <li>
                       <a href="/docs/10.x/sanctum" class="flex">
                     ...
                     <li>
                       <a href="/docs/10.x/scout" class="flex">
                     ...
                     <li>
                       <a href="/docs/10.x/socialite" class="flex">
                     ...
                     <li>
                       <a href="/docs/10.x/telescope" class="flex">
                     ...
                     <li>
                       <a href="/docs/10.x/valet" class="flex">
           ...
           <div class="flex-1 flex items-center justify-end">
             ...
             <button class="ml-2 relative w-10 h-10 inline-flex items-center justify-center p-2 text-gray-700 lg:hidden" aria-label="Toggle Menu" @click.prevent="navIsOpen = !navIsOpen">
               ...
               <svg x-show="navIsOpen" x-cloak class="absolute inset-0 mt-2.5 ml-2.5 w-5" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                 <rect y="1.41406" width="2" height="24" transform="rotate(-45 0 1.41406)" fill="currentColor" />
                 <rect width="2" height="24" transform="matrix(0.707107 0.707107 0.707107 -0.707107 0.192383 16.9707)" fill="currentColor" />
               </svg>
             </button>
           </div>
         </div>
       </div>
       <div x-show="navIsOpen" class="lg:hidden" x-transition:enter="duration-150" x-transition:leave="duration-100 ease-in" x-cloak>
         <nav x-show="navIsOpen" x-transition.opacity x-cloak class="fixed inset-0 w-full pt-[4.2rem] z-10 pointer-events-none">
           <div class="relative h-full w-full py-8 px-5 bg-white pointer-events-auto overflow-y-auto">
             <ul>
               ...
               <li class="flex sm:justify-center"><a class="group relative inline-flex border border-red-600 focus:outline-none mt-3 w-full max-w-md" href="/docs">
                   <span class="w-full inline-flex items-center justify-center self-stretch px-4 py-2 text-sm text-red-600 text-center font-bold uppercase bg-white ring-1 ring-red-600 ring-offset-1 transform transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
                     Documentation
                   </span>
                 </a>
   ...
   <div>
    ...
    }" :class="initializeAnimation ? 'animate-cube' : ''" class="text-red-600" width="46" height="53" viewBox="0 0 46 53" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <?php include './section.php'; ?>
       ...
       <div x-data="{
        ...
        updateScrollPosition(event) {
         ...
         <nav class="w-full flex relative lg:max-w-xs">
           ...
           <ul id="feature-nav" class="flex-1 divide-x lg:divide-x-0 lg:divide-y divide-gray-100 max-h-full overflow-x-scroll lg:overflow-y-scroll overscroll-y-contain flex lg:block whitespace-nowrap text-sm lg:text-base" @scroll.throttle.50ms="updateScrollPosition">
             <li>
               <a href="#authentication" class="text-left p-4 lg:py-6 flex items-center gap-3" :class="tab === 'authentication' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('authentication')">
             ...
             <li>
               <a href="#authorization" class="text-left p-4 lg:py-6 flex items-center gap-3" :class="tab === 'authorization' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('authorization')">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
             ...
             <li>
               <a href="#eloquent" class="text-left p-4 lg:py-6 flex items-center gap-3" :class="tab === 'eloquent' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('eloquent')">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
                 ...
                 <span class="font-medium">Eloquent ORM</span>
               </a>
             </li>
             <li>
               <a href="#migrations" class="text-left p-4 lg:py-6 flex items-center gap-3" :class="tab === 'migrations' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('migrations')">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
                   <path stroke-linecap="round" stroke-linejoin="round" d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />
                 </svg>
                 <span class="font-medium">Database Migrations</span>
               </a>
             </li>
             <li>
               <a href="#validation" class="text-left p-4 lg:py-6 flex items-center gap-3" :class="tab === 'validation' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('validation')">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
             ...
             <li>
               <a href="#notifications" class="text-left p-4 lg:py-6 flex items-center gap-3" :class="tab === 'notifications' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('notifications')">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
                   <path stroke-linecap="round" stroke-linejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0M3.124 7.5A8.969 8.969 0 015.292 3m13.416 0a8.969 8.969 0 012.168 4.5" />
                 </svg>
                 <span class="font-medium">Notifications &amp; Mail</span>
               </a>
             </li>
             <li>
               <a href="#storage" class="text-left p-4 lg:py-6 flex items-center gap-3" :class="tab === 'storage' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('storage')">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
             ...
             <li>
               <a href="#queues" class="text-left p-4 lg:py-6 flex items-center gap-3" :class="tab === 'queues' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('queues')">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
                   <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 010 3.75H5.625a1.875 1.875 0 010-3.75z" />
                 </svg>
                 <span class="font-medium">Job Queues</span>
               </a>
             </li>
             <li>
               <a href="#scheduling" class="text-left p-4 lg:py-6 flex items-center gap-3" :class="tab === 'scheduling' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('scheduling')">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
                   <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                 </svg>
                 <span class="font-medium">Task Scheduling</span>
               </a>
             </li>
             <li>
               <a href="#testing" class="text-left p-4 lg:py-6 flex items-center gap-3" :class="tab === 'testing' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('testing')">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
             ...
             <li>
               <a href="#events" class="text-left p-4 lg:py-6 flex items-center gap-3" :class="tab === 'events' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('events')">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
                   <path stroke-linecap="round" stroke-linejoin="round" d="M7.5 21L3 16.5m0 0L7.5 12M3 16.5h13.5m0-13.5L21 7.5m0 0L16.5 12M21 7.5H7.5" />
                 </svg>
                 <span class="font-medium">Events &amp; WebSockets</span>
               </a>
             </li>
           </ul>
         ...
         <div class="flex-1 overflow-scroll">
           <div x-init="tabs.push('authentication')"></div>

           <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'authentication'">
             <h3 class="font-bold text-2xl">Authentication</h3>
             <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
               ...
               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #FFCB8B;">Route</span><span style="color: #89DDFF;">::</span><span style="color: #82AAFF;">get</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">/profile</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">, </span><span style="color: #FFCB8B;">ProfileController</span><span style="color: #89DDFF;">::</span><span style="color: #C792EA;">class</span><span style="color: #BFC7D5;">)</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">middleware</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">auth</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">);</span></div></code></pre>

               <p>Once the user is authenticated, you can access the authenticated user via the <code>Auth</code> facade:</p>

               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #C792EA;">use</span><span style="color: #BFC7D5;"> Illuminate\Support\Facades\</span><span style="color: #FFCB8B;">Auth</span><span style="color: #BFC7D5;">;</span></div><div class='line'>&nbsp;</div><div class='line'><span style="color: #697098;">//</span><span style="color: #697098;"> Get the currently authenticated user...</span></div><div class='line'><span style="color: #BEC5D4;">$user</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">=</span><span style="color: #BFC7D5;"> </span><span style="color: #FFCB8B;">Auth</span><span style="color: #89DDFF;">::</span><span style="color: #82AAFF;">user</span><span style="color: #BFC7D5;">();</span></div></code></pre>
           ...
           <div x-init="tabs.push('authorization')"></div>

           <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'authorization'">
             <h3 class="font-bold text-2xl">Authorization</h3>
             <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
               ...
               <pre><code data-theme="olaolu-palenight" data-lang="bash" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #BFC7D5;">php </span><span style="color: #BFC7D5;">artisan</span><span style="color: #BFC7D5;"> </span><span style="color: #BFC7D5;">make:policy</span><span style="color: #BFC7D5;"> </span><span style="color: #BFC7D5;">UserPolicy</span></div></code></pre>
               ...
               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight has-focus-lines" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #C792EA;">public</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">function</span><span style="color: #BFC7D5;"> </span><span style="color: #82AAFF;">update</span><span style="color: #D9F5DD;">(</span><span style="color: #FFCB8B;">Request</span><span style="color: #BFC7D5;"> </span><span style="color: #BEC5D4;">$request</span><span style="color: #BFC7D5;">, </span><span style="color: #FFCB8B;">Invoice</span><span style="color: #BFC7D5;"> </span><span style="color: #BEC5D4;">$invoice</span><span style="color: #D9F5DD;">)</span></div><div class='line'><span style="color: #BFC7D5;">{</span></div><div class='line line-focus'><span style="color: #BFC7D5;">    </span><span style="color: #FFCB8B;">Gate</span><span style="color: #89DDFF;">::</span><span style="color: #82AAFF;">authorize</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">update</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">, </span><span style="color: #BEC5D4;">$invoice</span><span style="color: #BFC7D5;">);</span></div><div class='line'>&nbsp;</div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #BEC5D4;">$invoice</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">update</span><span style="color: #BFC7D5;">(</span><span style="color: #697098;">/*</span><span style="color: #697098;"> ... </span><span style="color: #697098;">*/</span><span style="color: #BFC7D5;">);</span></div><div class='line'><span style="color: #BFC7D5;">}</span></div></code></pre>

               <p><a href="https://laravel.com/docs/authorization">Learn more</a></p>
             </div>
           </div>

           <div x-init="tabs.push('eloquent')"></div>

           <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'eloquent'">
             <h3 class="font-bold text-2xl">Eloquent ORM</h3>
             <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
               ...
               <pre><code data-theme="olaolu-palenight" data-lang="text" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #BFC7D5;">php artisan make:model Invoice --migration</span></div></code></pre>
               ...
               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #697098;">//</span><span style="color: #697098;"> Create a related model...</span></div><div class='line'><span style="color: #BEC5D4;">$user</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">invoices</span><span style="color: #BFC7D5;">()</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">create</span><span style="color: #BFC7D5;">([</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">amount</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;"> </span><span style="color: #89DDFF;">=&gt;</span><span style="color: #BFC7D5;"> </span><span style="color: #F78C6C;">100</span><span style="color: #BFC7D5;">]);</span></div><div class='line'>&nbsp;</div><div class='line'><span style="color: #697098;">//</span><span style="color: #697098;"> Update a model...</span></div><div class='line'><span style="color: #BEC5D4;">$invoice</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">update</span><span style="color: #BFC7D5;">([</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">amount</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;"> </span><span style="color: #89DDFF;">=&gt;</span><span style="color: #BFC7D5;"> </span><span style="color: #F78C6C;">200</span><span style="color: #BFC7D5;">]);</span></div><div class='line'>&nbsp;</div><div class='line'><span style="color: #697098;">//</span><span style="color: #697098;"> Retrieve models...</span></div><div class='line'><span style="color: #BEC5D4;">$invoices</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">=</span><span style="color: #BFC7D5;"> </span><span style="color: #FFCB8B;">Invoice</span><span style="color: #89DDFF;">::</span><span style="color: #82AAFF;">unpaid</span><span style="color: #BFC7D5;">()</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">where</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">amount</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">, </span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">&gt;=</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">, </span><span style="color: #F78C6C;">100</span><span style="color: #BFC7D5;">)</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">get</span><span style="color: #BFC7D5;">();</span></div><div class='line'>&nbsp;</div><div class='line'><span style="color: #697098;">//</span><span style="color: #697098;"> Rich API for model interactions...</span></div><div class='line'><span style="color: #BEC5D4;">$invoices</span><span style="color: #89DDFF;">-&gt;each-&gt;</span><span style="color: #82AAFF;">pay</span><span style="color: #BFC7D5;">();</span></div></code></pre>

               <p><a href="https://laravel.com/docs/eloquent">Learn more</a></p>
             </div>
           </div>

           <div x-init="tabs.push('migrations')"></div>

           <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'migrations'">
             <h3 class="font-bold text-2xl">Database Migrations</h3>
             <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
               ...
               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #C792EA;">public</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">function</span><span style="color: #BFC7D5;"> </span><span style="color: #82AAFF;">up</span><span style="color: #D9F5DD;">()</span><span style="color: #89DDFF;">:</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">void</span></div><div class='line'><span style="color: #BFC7D5;">{</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #FFCB8B;">Schema</span><span style="color: #89DDFF;">::</span><span style="color: #82AAFF;">create</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">flights</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">, </span><span style="color: #C792EA;">function</span><span style="color: #BFC7D5;"> </span><span style="color: #D9F5DD;">(</span><span style="color: #FFCB8B;">Blueprint</span><span style="color: #BFC7D5;"> </span><span style="color: #BEC5D4;">$table</span><span style="color: #D9F5DD;">)</span><span style="color: #BFC7D5;"> {</span></div><div class='line'><span style="color: #BFC7D5;">        </span><span style="color: #BEC5D4;">$table</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">uuid</span><span style="color: #BFC7D5;">()</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">primary</span><span style="color: #BFC7D5;">();</span></div><div class='line'><span style="color: #BFC7D5;">        </span><span style="color: #BEC5D4;">$table</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">foreignUuid</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">airline_id</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">)</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">constrained</span><span style="color: #BFC7D5;">();</span></div><div class='line'><span style="color: #BFC7D5;">        </span><span style="color: #BEC5D4;">$table</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">string</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">name</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">);</span></div><div class='line'><span style="color: #BFC7D5;">        </span><span style="color: #BEC5D4;">$table</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">timestamps</span><span style="color: #BFC7D5;">();</span></div><div class='line'><span style="color: #BFC7D5;">    });</span></div><div class='line'><span style="color: #BFC7D5;">}</span></div></code></pre>

               <p><a href="https://laravel.com/docs/migrations">Learn more</a></p>
             </div>
           </div>

           <div x-init="tabs.push('validation')"></div>

           <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'validation'">
             <h3 class="font-bold text-2xl">Validation</h3>
             <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
               ...
               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight has-focus-lines" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #C792EA;">public</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">function</span><span style="color: #BFC7D5;"> </span><span style="color: #82AAFF;">update</span><span style="color: #D9F5DD;">(</span><span style="color: #FFCB8B;">Request</span><span style="color: #BFC7D5;"> </span><span style="color: #BEC5D4;">$request</span><span style="color: #D9F5DD;">)</span></div><div class='line'><span style="color: #BFC7D5;">{</span></div><div class='line line-focus'><span style="color: #BFC7D5;">    </span><span style="color: #BEC5D4;">$validated</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">=</span><span style="color: #BFC7D5;"> </span><span style="color: #BEC5D4;">$request</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">validate</span><span style="color: #BFC7D5;">([</span></div><div class='line line-focus'><span style="color: #BFC7D5;">        </span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">email</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;"> </span><span style="color: #89DDFF;">=&gt;</span><span style="color: #BFC7D5;"> </span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">required|email|unique:users</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">,</span></div><div class='line line-focus'><span style="color: #BFC7D5;">        </span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">password</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;"> </span><span style="color: #89DDFF;">=&gt;</span><span style="color: #BFC7D5;"> </span><span style="color: #FFCB8B;">Password</span><span style="color: #89DDFF;">::</span><span style="color: #82AAFF;">required</span><span style="color: #BFC7D5;">()</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">min</span><span style="color: #BFC7D5;">(</span><span style="color: #F78C6C;">8</span><span style="color: #BFC7D5;">)</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">uncompromised</span><span style="color: #BFC7D5;">(),</span></div><div class='line line-focus'><span style="color: #BFC7D5;">    ]);</span></div><div class='line'>&nbsp;</div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #BEC5D4;">$request</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">user</span><span style="color: #BFC7D5;">()</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">update</span><span style="color: #BFC7D5;">(</span><span style="color: #BEC5D4;">$validated</span><span style="color: #BFC7D5;">);</span></div><div class='line'><span style="color: #BFC7D5;">}</span></div></code></pre>

               <p><a href="https://laravel.com/docs/validation">Learn more</a></p>
             </div>
           </div>

           <div x-init="tabs.push('notifications')"></div>

           <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'notifications'">
             <h3 class="font-bold text-2xl">Notifications &amp; Mail</h3>
             <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
           ...
           <div x-init="tabs.push('storage')"></div>

           <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'storage'">
             <h3 class="font-bold text-2xl">File Storage</h3>
             <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
               ...
               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #BEC5D4;">$path</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">=</span><span style="color: #BFC7D5;"> </span><span style="color: #BEC5D4;">$request</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">file</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">avatar</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">)</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">store</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">s3</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">);</span></div></code></pre>

               <p>Regardless of where your files are stored, interact with them using Laravel's simple, elegant syntax:</p>

               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #BEC5D4;">$content</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">=</span><span style="color: #BFC7D5;"> </span><span style="color: #FFCB8B;">Storage</span><span style="color: #89DDFF;">::</span><span style="color: #82AAFF;">get</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">photo.jpg</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">);</span></div><div class='line'>&nbsp;</div><div class='line'><span style="color: #FFCB8B;">Storage</span><span style="color: #89DDFF;">::</span><span style="color: #82AAFF;">put</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">photo.jpg</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">, </span><span style="color: #BEC5D4;">$content</span><span style="color: #BFC7D5;">);</span></div></code></pre>

               <p><a href="https://laravel.com/docs/filesystem">Learn more</a></p>
             </div>
           </div>

           <div x-init="tabs.push('queues')"></div>

           <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'queues'">
             <h3 class="font-bold text-2xl">Job Queues</h3>
             <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
               <p>Laravel lets you to offload slow jobs to a background queue, keeping your web requests snappy:</p>

               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight has-focus-lines" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #BEC5D4;">$podcast</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">=</span><span style="color: #BFC7D5;"> </span><span style="color: #FFCB8B;">Podcast</span><span style="color: #89DDFF;">::</span><span style="color: #82AAFF;">create</span><span style="color: #BFC7D5;">(</span><span style="color: #697098;">/*</span><span style="color: #697098;"> ... </span><span style="color: #697098;">*/</span><span style="color: #BFC7D5;">);</span></div><div class='line'>&nbsp;</div><div class='line line-focus'><span style="color: #FFCB8B;">ProcessPodcast</span><span style="color: #89DDFF;">::</span><span style="color: #82AAFF;">dispatch</span><span style="color: #BFC7D5;">(</span><span style="color: #BEC5D4;">$podcast</span><span style="color: #BFC7D5;">)</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">onQueue</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">podcasts</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">);</span></div></code></pre>

               <p>You can run as many queue workers as you need to handle your workload:</p>

               <pre><code data-theme="olaolu-palenight" data-lang="bash" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #BFC7D5;">php </span><span style="color: #BFC7D5;">artisan</span><span style="color: #BFC7D5;"> </span><span style="color: #BFC7D5;">queue:work</span><span style="color: #BFC7D5;"> </span><span style="color: #BFC7D5;">redis</span><span style="color: #BFC7D5;"> </span><span style="color: #82AAFF;">--queue=podcasts</span></div></code></pre>
           ...
           <div x-init="tabs.push('scheduling')"></div>

           <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'scheduling'">
             <h3 class="font-bold text-2xl">Task Scheduling</h3>
             <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
               <p>Schedule recurring jobs and commands with an expressive syntax and say goodbye to complicated configuration files:</p>

               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #BEC5D4;">$schedule</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">job</span><span style="color: #BFC7D5;">(</span><span style="color: #FFCB8B;">NotifySubscribers</span><span style="color: #89DDFF;">::</span><span style="color: #C792EA;">class</span><span style="color: #BFC7D5;">)</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">hourly</span><span style="color: #BFC7D5;">();</span></div></code></pre>

               <p>Laravel's scheduler can even handle multiple servers and offers built-in overlap prevention:</p>

               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #BEC5D4;">$schedule</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">job</span><span style="color: #BFC7D5;">(</span><span style="color: #FFCB8B;">NotifySubscribers</span><span style="color: #89DDFF;">::</span><span style="color: #C792EA;">class</span><span style="color: #BFC7D5;">)</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">dailyAt</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">9:00</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">)</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">onOneServer</span><span style="color: #BFC7D5;">();</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">withoutOverlapping</span><span style="color: #BFC7D5;">();</span></div></code></pre>

               <p><a href="https://laravel.com/docs/scheduling">Learn more</a></p>
             </div>
           </div>

           <div x-init="tabs.push('testing')"></div>

           <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'testing'">
             <h3 class="font-bold text-2xl">Testing</h3>
             <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
               ...
               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #BEC5D4;">$user</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">=</span><span style="color: #BFC7D5;"> </span><span style="color: #FFCB8B;">User</span><span style="color: #89DDFF;">::</span><span style="color: #82AAFF;">factory</span><span style="color: #BFC7D5;">()</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">create</span><span style="color: #BFC7D5;">();</span></div><div class='line'>&nbsp;</div><div class='line'><span style="color: #FF5572;">$this</span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">browse</span><span style="color: #BFC7D5;">(</span><span style="color: #C792EA;">fn</span><span style="color: #BFC7D5;"> </span><span style="color: #D9F5DD;">(</span><span style="color: #FFCB8B;">Browser</span><span style="color: #BFC7D5;"> </span><span style="color: #BEC5D4;">$browser</span><span style="color: #D9F5DD;">)</span><span style="color: #BFC7D5;"> =&gt; </span><span style="color: #BEC5D4;">$browser</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">visit</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">/login</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">)</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">type</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">email</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">, </span><span style="color: #BEC5D4;">$user</span><span style="color: #89DDFF;">-&gt;email</span><span style="color: #BFC7D5;">)</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">type</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">password</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">, </span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">password</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">)</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">press</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">Login</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">)</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">assertPathIs</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">/home</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">)</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #89DDFF;">-&gt;</span><span style="color: #82AAFF;">assertSee</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&quot;</span><span style="color: #C3E88D;">Welcome {</span><span style="color: #BEC5D4;">$user</span><span style="color: #89DDFF;">-&gt;name</span><span style="color: #C3E88D;">}</span><span style="color: #D9F5DD;">&quot;</span><span style="color: #BFC7D5;">)</span></div><div class='line'><span style="color: #BFC7D5;">);</span></div></code></pre>

               <p><a href="https://laravel.com/docs/testing">Learn more</a></p>
             </div>
           </div>

           <div x-init="tabs.push('events')"></div>

           <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'events'">
             <h3 class="font-bold text-2xl">Events &amp; WebSockets</h3>
             <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
               ...
               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #FFCB8B;">OrderShipped</span><span style="color: #89DDFF;">::</span><span style="color: #82AAFF;">dispatch</span><span style="color: #BFC7D5;">(</span><span style="color: #BEC5D4;">$order</span><span style="color: #BFC7D5;">);</span></div></code></pre>

               <pre><code data-theme="olaolu-palenight" data-lang="php" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #C792EA;">class</span><span style="color: #BFC7D5;"> </span><span style="color: #FFCB6B;">SendShipmentNotification</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">implements</span><span style="color: #BFC7D5;"> </span><span style="color: #A9C77D;">ShouldQueue</span></div><div class='line'><span style="color: #BFC7D5;">{</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #C792EA;">public</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">function</span><span style="color: #BFC7D5;"> </span><span style="color: #82AAFF;">handle</span><span style="color: #D9F5DD;">(</span><span style="color: #FFCB8B;">OrderShipped</span><span style="color: #BFC7D5;"> </span><span style="color: #BEC5D4;">$event</span><span style="color: #D9F5DD;">)</span><span style="color: #89DDFF;">:</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">void</span></div><div class='line'><span style="color: #BFC7D5;">    {</span></div><div class='line'><span style="color: #BFC7D5;">        </span><span style="color: #697098;">//</span><span style="color: #697098;"> ...</span></div><div class='line'><span style="color: #BFC7D5;">    }</span></div><div class='line'><span style="color: #BFC7D5;">}</span></div></code></pre>
               ...
               <pre><code data-theme="olaolu-palenight" data-lang="javascript" class="torchlight" style="background-color: #292D3E; --theme-selection-background: #7580B850;"><!-- Syntax highlighted by torchlight.dev --><div class='line'><span style="color: #BFC7D5;">Echo</span><span style="color: #C792EA;">.</span><span style="color: #82AAFF;">private</span><span style="color: #BFC7D5;">(</span><span style="color: #BFC7D5;">`</span><span style="color: #C3E88D;">orders.</span><span style="color: #D3423E;">${</span><span style="color: #BFC7D5;">orderId</span><span style="color: #D3423E;">}</span><span style="color: #BFC7D5;">`</span><span style="color: #BFC7D5;">)</span></div><div class='line'><span style="color: #BFC7D5;">    </span><span style="color: #C792EA;">.</span><span style="color: #82AAFF;">listen</span><span style="color: #BFC7D5;">(</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #C3E88D;">OrderShipped</span><span style="color: #D9F5DD;">&#39;</span><span style="color: #BFC7D5;">, </span><span style="color: #D9F5DD;">(</span><span style="color: #7986E7;">e</span><span style="color: #D9F5DD;">)</span><span style="color: #BFC7D5;"> </span><span style="color: #C792EA;">=&gt;</span><span style="color: #BFC7D5;"> {</span></div><div class='line'><span style="color: #BFC7D5;">        console</span><span style="color: #C792EA;">.</span><span style="color: #82AAFF;">log</span><span style="color: #BFC7D5;">(e</span><span style="color: #C792EA;">.</span><span style="color: #89DDFF;">order</span><span style="color: #BFC7D5;">);</span></div><div class='line'><span style="color: #BFC7D5;">    });</span></div></code></pre>
   ...
   <div class="relative overflow-hidden pt-16 pb-24 lg:pt-48">
     <span class="hidden absolute bg-radial-gradient opacity-[.15] pointer-events-none lg:inline-flex left-[-20%] top-0 w-[640px] h-[640px]"></span>
       ...
       <div class="relative w-full grid gap-12 lg:grid-cols-2">
         ...
         <div class="w-full flex justify-center items-center px-5 xl:px-0">
           <div class="sm:max-w-[480px]">
             ...
             <a class="group relative inline-flex border border-red-600 focus:outline-none mt-6" href="/docs/http-tests">
               <span class="w-full inline-flex items-center justify-center self-stretch px-4 py-2 text-sm text-red-600 text-center font-bold uppercase bg-white ring-1 ring-red-600 ring-offset-1 transform transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
                 Learn More
               </span>
             </a>
   ...
   <div class="max-w-screen-xl mx-auto px-5 pt-16 pb-24 md:pt-24 lg:pt-48">
     ...
     <ul class="mt-10 relative grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
       <li>
         <a href="/docs/10.x/starter-kits#laravel-breeze" class="flex p-4 border border-gray-200 border-opacity-60">
       ...
       <li>
         <a href="/docs/10.x/billing" class="flex p-4 border border-gray-200 border-opacity-60">
       ...
       <li>
         <a href="/docs/10.x/dusk" class="flex p-4 border border-gray-200 border-opacity-60">
       ...
       <li>
         <a href="/docs/10.x/broadcasting" class="flex p-4 border border-gray-200 border-opacity-60">
       ...
       <li>
         <a href="https://envoyer.io" class="flex p-4 border border-gray-200 border-opacity-60">
           <div class="relative shrink-0 bg-envoyer flex items-center justify-center w-12 h-12 rounded-lg overflow-hidden">
             <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
       ...
       <li>
         <a href="/docs/10.x/horizon" class="flex p-4 border border-gray-200 border-opacity-60">
       ...
       <li>
         <a href="/docs/10.x/octane" class="flex p-4 border border-gray-200 border-opacity-60">
       ...
       <li>
         <a href="/docs/10.x/pint" class="flex p-4 border border-gray-200 border-opacity-60">
       ...
       <li>
         <a href="/docs/10.x/sail" class="flex p-4 border border-gray-200 border-opacity-60">
       ...
       <li>
         <a href="/docs/10.x/sanctum" class="flex p-4 border border-gray-200 border-opacity-60">
       ...
       <li>
         <a href="/docs/10.x/scout" class="flex p-4 border border-gray-200 border-opacity-60">
       ...
       <li>
         <a href="/docs/10.x/socialite" class="flex p-4 border border-gray-200 border-opacity-60">
       ...
       <li>
         <a href="/docs/10.x/telescope" class="flex p-4 border border-gray-200 border-opacity-60">
       ...
       <li>
         <a href="/docs/10.x/valet" class="flex p-4 border border-gray-200 border-opacity-60">
   ...
   <div class="relative max-w-screen-xl mx-auto px-5 pt-16 md:pt-24 lg:pt-36 pb-24">
     ...
     <div class="mt-14 relative columns-1 gap-5 space-y-5 sm:columns-2 lg:columns-3">
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“I’ve been using Laravel for nearly a decade and never been tempted to switch to anything else.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/adam-wathan.jpg" class="w-10 h-10 object-cover object-center" alt="Adam Wathan">
           <div class="text-xs">
             <cite class="not-italic">Adam Wathan</cite>
             <p class="text-gray-700">Creator of <a href="https://tailwindcss.com/" target="_blank" class="text-red-500">Tailwind CSS</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         ...
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/aaron-francis.jpg" class="w-10 h-10 object-cover object-center" alt="Aaron Francis">
           <div class="text-xs">
             <cite class="not-italic">Aaron Francis</cite>
             <p class="text-gray-700">Creator of <a href="https://torchlight.dev" target="_blank" class="text-red-500">Torchlight</a> and <a href="https://github.com/hammerstonedev/sidecar" target="_blank" class="text-red-500">Sidecar</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“Laravel grew out to be an amazing innovative and active community. Laravel is so much more than just a PHP framework.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/bobby-bouwmann.jpg" class="w-10 h-10 object-cover object-center" alt="Bobby Bouwmann">
           <div class="text-xs">
             <cite class="not-italic">Bobby Bouwmann</cite>
             <p class="text-gray-700">Elite Developer at <a href="https://enrise.com/" target="_blank" class="text-red-500">Enrise</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“As an old school PHP developer, I have tried many frameworks; none has given me the development speed and enjoyment of use that I found with Laravel. It is a breath of fresh air in the PHP ecosystem, with a brilliant community around it.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/erika-heidi.jpg" class="w-10 h-10 object-cover object-center" alt="Erika Heidi">
           <div class="text-xs">
             <cite class="not-italic">Erika Heidi</cite>
             <p class="text-gray-700">Creator of <a href="https://github.com/minicli/minicli" target="_blank" class="text-red-500">Minicli</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“Laravel is nothing short of a delight. It allows me to build any web-y thing I want in record speed with joy.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/caleb-porzio.jpg" class="w-10 h-10 object-cover object-center" alt="Caleb Porzio">
           <div class="text-xs">
             <cite class="not-italic">Caleb Porzio</cite>
             <p class="text-gray-700">Creator of <a href="https://laravel-livewire.com" target="_blank" class="text-red-500">Livewire</a> and <a href="https://alpinejs.dev" target="_blank" class="text-red-500">Alpine.js</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“I found Laravel by chance, but I knew right away that I found my thing. The framework, the ecosystem and the community - it’s the perfect package. I’ve worked on amazing projects and met incredible people; it’s safe to say that Laravel changed my life.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/zuzana-kunckova.jpg" class="w-10 h-10 object-cover object-center" alt="Zuzana Kunckova">
           <div class="text-xs">
             <cite class="not-italic">Zuzana Kunckova</cite>
             <p class="text-gray-700">Full-Stack Developer</p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“Laravel’s best-in-class testing tools give me the peace of mind to ship robust apps quickly.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/michael-dyrynda.jpg" class="w-10 h-10 object-cover object-center" alt="Michael Dyrynda">
           <div class="text-xs">
       ...
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         ...
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/chris-arter.jpg" class="w-10 h-10 object-cover object-center" alt="Chris Arter">
           <div class="text-xs">
             <cite class="not-italic">Chris Arter</cite>
             <p class="text-gray-700">Developer at <a href="https://www.bankrate.com" target="_blank" class="text-red-500">Bankrate</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“I&#039;ve been using Laravel for over 10 years and I can&#039;t imagine using PHP without it.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/eric-l-barnes.jpg" class="w-10 h-10 object-cover object-center" alt="Eric L. Barnes">
           <div class="text-xs">
             <cite class="not-italic">Eric L. Barnes</cite>
             <p class="text-gray-700">Founder of <a href="https://laravel-news.com/" target="_blank" class="text-red-500">Laravel News</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“I&#039;ve been enjoying Laravel&#039;s focus on pushing developer experience to the next level for many years. All pieces of the ecosystem are powerful, well designed, fun to work with, and have stellar documentation. The surrounding friendly and helpful community is a joy to be a part of.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/freek-van-der-herten.jpg" class="w-10 h-10 object-cover object-center" alt="Freek Van der Herten">
           <div class="text-xs">
             <cite class="not-italic">Freek Van der Herten</cite>
             <p class="text-gray-700">Owner of <a href="https://spatie.be" target="_blank" class="text-red-500">Spatie</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“Laravel and its ecosystem of tools help me build client projects faster, more secure, and higher quality than any other tools out there.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/jason-beggs.jpg" class="w-10 h-10 object-cover object-center" alt="Jason Beggs">
           <div class="text-xs">
             <cite class="not-italic">Jason Beggs</cite>
             <p class="text-gray-700">Owner of <a href="https://roasted.dev" target="_blank" class="text-red-500">roasted.dev</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“I didn&#039;t fully appreciate Laravel&#039;s one-stop-shop, all-encompassing solution, until I tried (many) different ecosystems. Laravel is in a class of its own!“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/joseph-silber.jpg" class="w-10 h-10 object-cover object-center" alt="Joseph Silber">
           <div class="text-xs">
             <cite class="not-italic">Joseph Silber</cite>
             <p class="text-gray-700">Creator of <a href="https://github.com/JosephSilber/bouncer" target="_blank" class="text-red-500">Bouncer</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“Laravel has helped me launch products quicker than any other solution, allowing me to get to market faster and faster as the community has evolved.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/steve-mcdougall.jpg" class="w-10 h-10 object-cover object-center" alt="Steve McDougall">
           <div class="text-xs">
             <cite class="not-italic">Steve McDougall</cite>
             <p class="text-gray-700">Creator of <a href="https://github.com/JustSteveKing/laravel-transporter" target="_blank" class="text-red-500">Laravel Transporter</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“I&#039;ve been using Laravel for every project over the past ten years in a time where a new framework launches every day. To this date, there&#039;s just nothing like it.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/philo-hermans.jpg" class="w-10 h-10 object-cover object-center" alt="Philo Hermans">
           <div class="text-xs">
             <cite class="not-italic">Philo Hermans</cite>
             <p class="text-gray-700">Founder of <a href="https://anystack.sh/" target="_blank" class="text-red-500">Anystack</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“Laravel is for developers who write code because they can rather than because they have to.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/luke-downing.jpg" class="w-10 h-10 object-cover object-center" alt="Luke Downing">
           <div class="text-xs">
       ...
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“Laravel makes building web apps exciting! It has also helped me to become a better developer 🤙“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/tony-lea.jpg" class="w-10 h-10 object-cover object-center" alt="Tony Lea">
           <div class="text-xs">
             <cite class="not-italic">Tony Lea</cite>
             <p class="text-gray-700">Founder of <a href="https://devdojo.com" class="text-red-500" target="_blank">DevDojo</a></p>
           </div>
         </div>
       </blockquote>
       <blockquote class="relative w-full bg-white p-5 border border-gray-200 break-inside-avoid-column">
         <h2 class="text-sm">“The Laravel ecosystem has been integral to the success of our business. The framework allows us to move fast and ship regularly, and Laravel Vapor has allowed us to operate at an incredible scale with ease.“</h2>
         <div class="mt-5 flex items-start gap-4">
           <img src="/images/testimonials/jack-ellis.jpg" class="w-10 h-10 object-cover object-center" alt="Jack Ellis">
           <div class="text-xs">
             <cite class="not-italic">Jack Ellis</cite>
             <p class="text-gray-700">Co-founder of <a href="https://usefathom.com" class="text-red-500" target="_blank">Fathom Analytics</a></p>
           </div>
         </div>
       </blockquote>
     </div>
         ...
         <div class="sm:max-w-xl">
           ...
           <div class="mt-10 grid grid-cols-2 gap-10 md:grid-cols-3">
             <a href="https://blog.laravel.com" target="_blank" class="inline-flex items-center">
               <svg class="text-red-600 w-8 h-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                 <path stroke="currentColor" d="M.5.5h31v31H.5z" />
                 <path d="M10 9c7.18 0 13 5.82 13 13m-13-7a7 7 0 0 1 7 7m-6 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
               </svg>
             ...
             <a href="https://laracasts.com/discuss" target="_blank" class="inline-flex items-center">
               <svg class="text-red-600 w-8 h-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                 <path stroke="currentColor" d="M.5.5h31v31H.5z" />
                 <path d="M11 12h10-10Zm0 4h4-4Zm5 8-4-4H9a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-3l-4 4Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
               </svg>
             ...
             <a href="https://larajobs.com" target="_blank" class="inline-flex items-center">
               <svg class="text-red-600 w-8 h-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                 <path stroke="currentColor" d="M.5.5h31v31H.5z" />
                 <path d="M25 17.255A23.93 23.93 0 0 1 16 19c-3.183 0-6.22-.62-9-1.745M16 16h.01M20 10V8a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2h8ZM9 24h14a2 2 0 0 0 2-2V12a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
               </svg>
             ...
             <a href="https://laravel-news.com" target="_blank" class="inline-flex items-center">
               <svg class="text-red-600 w-8 h-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                 <path stroke="currentColor" d="M.5.5h31v31H.5z" />
                 <path d="M23 24H9a2 2 0 0 1-2-2V10a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v1m2 13a2 2 0 0 1-2-2V11m2 13a2 2 0 0 0 2-2v-9a2 2 0 0 0-2-2h-2m-4-3h-4m-2 12h6m-6-8h6v4h-6v-4Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
               </svg>
             ...
             <a href="https://laracasts.com" target="_blank" class="inline-flex items-center">
               <svg class="text-red-600 w-8 h-8" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                 <path stroke="currentColor" d="M.5.5h31v31H.5z" />
                 <path d="m18.752 15.168-3.197-2.132A1 1 0 0 0 14 13.87v4.263a1 1 0 0 0 1.555.832l3.197-2.132a.998.998 0 0 0 0-1.664v-.001Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
                 <path d="M25 16a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
               </svg>
     ...
     <div class="max-w-screen-xl mx-auto grid gap-6 px-5 pt-16 md:pt-24 pb-24 lg:grid-cols-2 lg:pt-48 lg:pb-64">
       ...
       <div class="relative flex justify-center lg:justify-end">
         <div class="sm:max-w-md">
           ...
           <a class="group relative inline-flex border border-red-600 focus:outline-none mt-8" href="https://partners.laravel.com">
             <span class="w-full inline-flex items-center justify-center self-stretch px-4 py-2 text-sm text-red-600 text-center font-bold uppercase bg-white ring-1 ring-red-600 ring-offset-1 transform transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
               Browse Partners
             </span>
           </a>
     ...
     <div class="max-w-screen-2xl mx-auto w-full px-5">
       ...
       <div class="mt-6 grid grid-cols-12 md:gap-x-8 gap-y-12 sm:mt-12">
           ...
           <ul class="mt-6 flex items-center space-x-3">
             <li>
               <a href="https://twitter.com/laravelphp">
                 <img class="hidden w-6 h-6" src="/img/social/twitter.dark.min.svg" alt="Twitter" width="24" height="20" loading="lazy">
                 <img class="inline-block w-6 h-6" src="/img/social/twitter.min.svg" alt="Twitter" width="24" height="20" loading="lazy">
               </a>
             </li>
             <li>
               <a href="https://github.com/laravel">
                 <img class="hidden w-6 h-6" src="/img/social/github.dark.min.svg" alt="GitHub" width="24" height="24" loading="lazy">
                 <img class="inline-block w-6 h-6" src="/img/social/github.min.svg" alt="GitHub" width="24" height="24" loading="lazy">
               </a>
             </li>
             <li>
               <a href="https://discord.gg/mPZNm7A">
                 <img class="hidden w-6 h-6" src="/img/social/discord.dark.min.svg" alt="Discord" width="21" height="24" loading="lazy">
                 <img class="inline-block w-6 h-6" src="/img/social/discord.min.svg" alt="Discord" width="21" height="24" loading="lazy">
               </a>
             </li>
             <li>
               <a href="https://www.youtube.com/laravelphp">
                 <img class="hidden w-6 h-6" src="/img/social/youtube.dark.min.svg" alt="YouTube" width="169" height="150" loading="lazy">
                 <img class="inline-block w-6 h-6" src="/img/social/youtube.min.svg" alt="YouTube" width="169" height="150" loading="lazy">
               </a>
             </li>
           </ul>
         </div>
         <div class="text-xs col-span-6 md:col-span-3 lg:col-span-2">
           ...
           <div class="mt-5">
             <ul class="space-y-3 text-gray-700 ">
               <li>
                 <a href="/team" class="transition-colors hover:text-gray-600 ">Our Team</a>
               </li>
               <li>
                 <a href="/docs/10.x/releases" class="transition-colors hover:text-gray-600 ">Release Notes</a>
               </li>
               <li>
                 <a href="/docs/10.x/installation" class="transition-colors hover:text-gray-600 ">Getting Started</a>
               </li>
               <li>
                 <a href="/docs/10.x/routing" class="transition-colors hover:text-gray-600 ">Routing</a>
               </li>
               <li>
                 <a href="/docs/10.x/blade" class="transition-colors hover:text-gray-600 ">Blade Templates</a>
               </li>
               <li>
                 <a href="/docs/10.x/authentication" class="transition-colors hover:text-gray-600 ">Authentication</a>
               </li>
               <li>
                 <a href="/docs/10.x/authorization" class="transition-colors hover:text-gray-600 ">Authorization</a>
               </li>
               <li>
                 <a href="/docs/10.x/artisan" class="transition-colors hover:text-gray-600 ">Artisan Console</a>
               </li>
               <li>
                 <a href="/docs/10.x/database" class="transition-colors hover:text-gray-600 ">Database</a>
               </li>
               <li>
                 <a href="/docs/10.x/eloquent" class="transition-colors hover:text-gray-600 ">Eloquent ORM</a>
               </li>
               <li>
                 <a href="/docs/10.x/testing" class="transition-colors hover:text-gray-600 ">Testing</a>
               </li>
             </ul>
           </div>
         </div>
         <div class="text-xs col-span-6 md:col-span-3 lg:col-span-2">
           ...
           <div class="mt-5">
             <ul class="space-y-3 text-gray-700 ">
               <li>
                 <a href="https://bootcamp.laravel.com" class="transition-colors hover:text-gray-600 ">Laravel Bootcamp</a>
               </li>
               <li>
               ...
               <li>
                 <a href="https://laracon.au" class="transition-colors hover:text-gray-600 ">Laracon AU</a>
               </li>
               <li>
                 <a href="https://laracon.eu/" class="transition-colors hover:text-gray-600 ">Laracon EU</a>
               </li>
               <li>
                 <a href="https://laracon.in/" class="transition-colors hover:text-gray-600 ">Laracon India</a>
               </li>
               <li>
               ...
               <li>
                 <a href="/trademark" class="transition-colors hover:text-gray-600 ">Trademark</a>
               </li>
             </ul>
           </div>
         </div>
         <div class="text-xs col-span-6 md:col-span-3 lg:col-span-2">
           ...
           <div class="mt-5">
             <ul class="space-y-3 text-gray-700 ">
               <li>
                 <a href="https://webreinvent.com/?utm_source=laravel&amp;utm_medium=laravel.com&amp;utm_campaign=footer-link" class="transition-colors hover:text-gray-600 ">WebReinvent</a>
               </li>
               <li>
               ...
               <li>
                 <a href="https://activelogic.com/" class="transition-colors hover:text-gray-600 ">Active Logic</a>
               </li>
               <li>
         ...
         <div class="text-xs col-span-6 md:col-span-3 lg:col-span-2">
           ...
           <div class="mt-5">
             <ul class="space-y-3 text-gray-700 ">
               <li>
                 <a href="/docs/10.x/billing" class="transition-colors hover:text-gray-600 ">Cashier</a>
               </li>
               <li>
                 <a href="/docs/10.x/dusk" class="transition-colors hover:text-gray-600 ">Dusk</a>
               </li>
               <li>
                 <a href="/docs/10.x/broadcasting" class="transition-colors hover:text-gray-600 ">Echo</a>
               </li>
               <li>
               ...
               <li>
                 <a href="/docs/10.x/horizon" class="transition-colors hover:text-gray-600 ">Horizon</a>
               </li>
               <li>
                 <a href="https://nova.laravel.com" class="transition-colors hover:text-gray-600 ">Nova</a>
               </li>
               <li>
                 <a href="/docs/10.x/octane" class="transition-colors hover:text-gray-600 ">Octane</a>
               </li>
               <li>
                 <a href="/docs/10.x/sail" class="transition-colors hover:text-gray-600 ">Sail</a>
               </li>
               <li>
                 <a href="/docs/10.x/sanctum" class="transition-colors hover:text-gray-600 ">Sanctum</a>
               </li>
               <li>
                 <a href="/docs/10.x/scout" class="transition-colors hover:text-gray-600 ">Scout</a>
               </li>
               <li>
                 <a href="https://spark.laravel.com" class="transition-colors hover:text-gray-600 ">Spark</a>
               </li>
               <li>
                 <a href="/docs/10.x/telescope" class="transition-colors hover:text-gray-600 ">Telescope</a>
               </li>
               <li>
                 <a href="/docs/10.x/valet" class="transition-colors hover:text-gray-600 ">Valet</a>
               </li>
               <li>
       ...
       <div class="mt-10 border-t pt-6 pb-16 border-gray-200 ">
         <p class="text-xs text-gray-700 ">
           Laravel is a Trademark of Taylor Otwell. Copyright &copy; 2011-2023 Laravel LLC.
         </p>
